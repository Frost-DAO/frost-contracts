...
contract StakedToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked FROST", "sFROST", 9) ERC20Permit() {
    ...
    /**
        @notice increases sFROST supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sFROST
